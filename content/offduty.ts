...
export const offDutyFeatured = {
  ...
  image: "/offduty/moto.jpg",
} as const;

export const offDutyRows: OffDutyRow[] = [
  { title: "DRAWING", subtitle: "pencils, ink, and the occasional tablet.", tags: ["SKETCH", "INK", "LINEWORK"] },
  { title: "MANGA & ANIME", subtitle: "raised on panels, arcs and late episodes.", tags: ["MANGA", "ANIME", "STORY"] },
  { title: "TECHNOLOGY", subtitle: "where the day job and the hobby blur.", tags: ["HARDWARE", "HOMELAB", "OPEN-SOURCE"] },
  { title: "GAMING", subtitle: "competitive when it counts, chill when it does not.", tags: ["FPS", "STRATEGY", "CO-OP"] },
];
