      ...
      <div ref={contentRef}>
        ...
        <div className="article-grid">
          ...
          <div>
            ...
            >
              {tr(
                "The apprenticeship at Arvato is second-line GRC inside Internal Control: EBIOS RM risk analyses, the ISO 27001 certification programme and the continuous improvement that carries it, ISREG alignment, PSSI and policy drafting, supplier assessments, vulnerability management. The work is governance-layer — translating frameworks into decisions an organisation can actually execute, then keeping the evidence that it did. What I am building toward is a hybrid profile: enough GRC to be credible on governance, enough technical depth for detection engineering and pipeline security. A Mastère in offensive and defensive cybersecurity starts in September 2026, carried on in apprenticeship at Arvato through to September 2028. The throughline is secure by design — policy without operational instrumentation is assumption, detection without governance accountability is noise no one owns, and the connective tissue between them is where security actually lives.",
                "Mon alternance chez Arvato, c'est de la GRC de seconde ligne au sein du Contrôle Interne : analyses de risques EBIOS RM, démarche de certification ISO 27001 et amélioration continue qui la porte, conformité ISREG, rédaction de la PSSI et des politiques, évaluation des fournisseurs, gestion des vulnérabilités. Tout se joue au niveau de la gouvernance : transformer des référentiels en décisions qu'une organisation peut vraiment appliquer, puis garder la trace qu'elle l'a fait. Mon cap, c'est un profil hybride : assez de GRC pour peser sur la gouvernance, assez de bagage technique pour le detection engineering et la sécurité des pipelines. Un Mastère en cybersécurité offensive et défensive m'attend en septembre 2026, poursuivi en alternance chez Arvato jusqu'en septembre 2028. Le fil rouge reste le secure by design : une politique sans instrumentation opérationnelle n'est qu'un pari, une détection sans gouvernance qui l'assume n'est qu'un bruit dont personne ne répond, et c'est précisément dans ce qui relie les deux que la sécurité prend vraiment corps."
              )}
            </p>
          </div>
